    ...
    while query != "":
        ...
        if query == "":
            ...
            try:
                ...
                # Maria's code for task 5 (covering also task 2)- Maria commented this away from the official program since task 2 was issued to Sofia
                ...
                # Using the three stars to find the end of the article title
                    if i > 9:
                        print("These were the first ten matches.")
                        break
